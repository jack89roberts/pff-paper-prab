...
\begin{figure}
\includegraphics[width=0.5\textwidth]{figs/meanJit}% Here is how to import EPS 
%art
...
\begin{figure}
\includegraphics[width=0.5\textwidth]{figs/shape}% Here is how to import EPS art
\caption{\label{fig:shape}Correction of pulse shape. \textcolor{red}{Add sample 
range or change axis limit}}
\end{figure}

\begin{figure}
	\includegraphics[width=0.5\textwidth]{figs/flatness}% Here is how to import 
	%EPS art
...
%
%\begin{figure}
%\includegraphics[width=0.5\textwidth]{figs/BestFF_pbp}% Here is how to import 
%%%%EPS art
