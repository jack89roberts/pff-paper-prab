...
In the context of XFELs feedback systems have been developed... microsecond 
latency, mhz bunch spacing, long pulses... clic feedforward, zero latency, ghz 
bunch spacing, short pulses, bandwidth...
...
and latency requirements. A prototype PFF system has therefore 
been designed, commissioned and operated at the CLIC test facility CTF3, at 
CERN, to prove its feasibility. The prototype system follows the same concept 
as the proposed CLIC scheme, and is the focus of this work. 
...
quoted in the paper are given in degrees at 12~GHz.
...
The achievable correlation is limited by the phase monitor resolution and any 
additional phase jitter introduced in the beam lines between the upstream and 
downstream phase monitors. The phase monitor resolution of \(0.12^\circ\) by 
itself limits the maximum upstream-downstream phase correlation to
\(98\%\) and the (measured) corrected downstream phase jitter to 
\(0.17^\circ\).
...
downstream phase jitter is reduced to the same level as the upstream jitter and 
the upstream-downstream phase correlation is also increased to above 95\%.

\textcolor{red}{In this way the necessary initial conditions for the PFF 
correction were 
...
\textcolor{red}{This represents the longest time period during which the target 
CLIC phase 
