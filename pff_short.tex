...
\textcolor{red}{MADX units for R52, R56, i.e. conversion between distance and phase.}
...
In this way the necessary initial conditions for the PFF correction were obtained at CTF3. However, the phase propagation is also sensitive to higher order phase--energy dependencies and beam energy drifts. These lead to apparent drifts in the optimal set point for \(R_{56}\) in TL1 and have made it difficult to maintain high correlation between the upstream and downstream phase on long timescales.
...
The system is operated in interleaved mode, with the correction 
...
2016: Std \(0.960\pm0.003^\circ\) reduced to \(0.285\pm0.004^\circ\) across 440~ns portion of pulse. Worse absolute but better removal small features compared to 2015.

Fig. improvement in shape... where corrected phase not flat corresponds to where there are differences between upstream and downstream phase...
...
\begin{figure}
	...
	\caption{\label{fig:shape}Correction of pulse shape. \textcolor{red}{Only show sample range?}}
\end{figure}
...
Fig.~\ref{fig:meanJit} shows downstream phase distributions across a dataset around ten minutes in length (482~pulses). An 
...
\(96\pm2\%\) to \(0\pm7\%\). The achieved stability is in agreement with the theoretical prediction (considering the initial correlation and jitter) of \(0.26\pm0.06^\circ\) within error bars.
...
\textcolor{red}{Result with wiggling?}
